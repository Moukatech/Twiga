...
WebUI.click(findTestObject('Harvest Page/Link Cancel Harvest'))

Mobile.delay(2)

WebUI.setText(findTestObject('Harvest Page/Input Cancel Reason'), 'Testing Module')

Mobile.delay(4)

not_run: WebUI.click(findTestObject('Harvest Page/Button Cancel Harvest'))
